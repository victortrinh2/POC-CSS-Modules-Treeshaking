...
export const i18nextInstanceKey = "poc-css-host-app";
...
export async function initI18next(runtime: ApplicationRuntime, options?: CreateI18nextInstanceOptions) {
    ...
    return createAndRegisterHostI18nextInstance(i18nextPlugin, options);
}

export async function createAndRegisterHostI18nextInstance(i18nextPlugin: i18nextPlugin, options: CreateI18nextInstanceOptions = {}) {
