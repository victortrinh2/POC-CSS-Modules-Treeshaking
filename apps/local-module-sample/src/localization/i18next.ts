...
export const i18nextInstanceKey = "poc-css-local-module-sample";
...
export async function initI18next(runtime: ApplicationRuntime, options?: CreateI18nextInstanceOptions) {
    ...
    return createAndRegisterLocalModuleSampleI18nextInstance(i18nextPlugin, options);
}

export async function createAndRegisterLocalModuleSampleI18nextInstance(i18nextPlugin: i18nextPlugin, options: CreateI18nextInstanceOptions = {}) {
