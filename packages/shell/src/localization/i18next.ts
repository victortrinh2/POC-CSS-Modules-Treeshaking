...
export const i18nextInstanceKey = "poc-css-shell";
...
export async function initI18next(runtime: ApplicationRuntime, options?: CreateI18nextInstanceOptions) {
    ...
    return createAndRegisterShellI18nextInstance(i18nextPlugin, options);
}

export async function createAndRegisterShellI18nextInstance(i18nextPlugin: i18nextPlugin, options: CreateI18nextInstanceOptions = {}) {
